    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {isAdmin && <button onClick={openMigration} className="btn-secondary">Department Migration</button>}
          <button onClick={() => openModal()} className="btn-primary">+ New Project</button>
        </div>
      </div>
