...
export default function Projects() {
  ...
  const [tab, setTab] = useState<'projects' | 'transactions' | 'shared'>('projects')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-1 border-b border-gray-200">
        {([['projects', 'Projects'], ['transactions', 'Transactions'], ['shared', 'Shared Expenses']] as const).map(([k, label]) => (
